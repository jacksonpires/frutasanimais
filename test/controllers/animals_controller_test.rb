...
class AnimalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create animal" do
    assert_difference('Animal.count') do
      post animals_url, params: { animal: { description: @animal.description, name: @animal.name } }
    end
  ...
  test "should update animal" do
    patch animal_url(@animal), params: { animal: { description: @animal.description, name: @animal.name } }
